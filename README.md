# Splitwise Clone: Social Finance & Expense Tracker

A modern, secure, and fully-featured application for tracking shared expenses and settling debts. Built with privacy and ease of use in mind, this project mirrors the core capabilities of Splitwise while enforcing strict data isolation and a secure connection graph.
