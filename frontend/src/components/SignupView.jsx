        ...
        <div className="w-full max-w-[420px] flex-none">
          <div className="bg-white rounded-2xl p-8 md:p-10 shadow-xl shadow-black/5 border border-gray-100">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button type="submit" disabled={isLoading} className="w-full bg-[#007A64] hover:bg-[#00604f] text-white text-sm font-bold py-3.5 rounded-xl shadow-md active:scale-95 transition-all duration-200 mt-2 disabled:opacity-70">
