...
import type { BalanceSummary, GroupDetail, User } from '../types/api';
...
export default function FriendDetailView({ friendId, users, rawBalances, groups, currentUserId, onBack, onSettleUp }: FriendDetailViewProps) {
