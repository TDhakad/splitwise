      ...
      <div className="w-full lg:w-[55%] flex flex-col justify-center px-6 sm:px-10 md:px-20 py-12 relative">
        ...
        <div className="w-full max-w-[420px] mx-auto">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={isLoading} className="w-full bg-[#007A64] hover:bg-[#00604f] text-white text-sm font-bold py-3.5 rounded-xl shadow-md active:scale-95 transition-all duration-200 mt-6 relative overflow-hidden group disabled:opacity-70 disabled:active:scale-100">
