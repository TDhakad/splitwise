...
import type { ReceiptLineItem, ReceiptReviewData } from '../types/ui';
...
export default function ReviewReceiptStep({ receiptImage, receiptData, setReceiptData, onNext, onClose, onBack }: ReviewReceiptStepProps) {
            ...
            <div className="w-1/2 p-6 overflow-y-auto border-r border-gray-200 bg-gray-50 flex justify-center">
              <div className="max-w-md w-full">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <a href={receiptHref} target="_blank" rel="noreferrer" className="text-sm font-bold text-[#007A64] flex items-center gap-1 hover:underline">
                    <MSIcon name="zoom_in" style={{ fontSize: 16 }} /> View Original
                  </a>
                </div>
                {receiptImage ? (
                  <img src={receiptHref} alt="Receipt" className="w-full rounded-xl shadow-md border border-gray-200" />
                ) : (
